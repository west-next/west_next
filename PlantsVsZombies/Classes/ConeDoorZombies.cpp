...
ConeDoorZombies* ConeDoorZombies::_instance = nullptr;

ConeDoorZombies* ConeDoorZombies::getInstance()
{
	if (_instance == nullptr)
	{
		_instance = new (std::nothrow)ConeDoorZombies;
	}
	return _instance;
}

void ConeDoorZombies::CreateConeDoorZombies(Node* node, const Vec2& Position, const int& tag, const int& AnimationID, const bool& IsReadyScene)
{
	...
	zombies.ZombiesType = Global::ZombiesType::ConeDoorZombies;
	zombies.MusicType = 1;
...
void ConeDoorZombies::CreateConeDoorZombiesAniamton(map<int, Global::_Zombies>::iterator Iter, Node* node)
{
...
void ConeDoorZombies::SetShieldPrimaryInjure(map<int, Global::_Zombies>::iterator iter, Node* node)
{
...
void ConeDoorZombies::SetShieldSecondaryInjure(map<int, Global::_Zombies>::iterator iter, Node* node)
{
...
void ConeDoorZombies::SetShieldThirdInjure(map<int, Global::_Zombies>::iterator iter, Node* node)
{
...
void ConeDoorZombies::SetShield1PrimaryInjure(map<int, Global::_Zombies>::iterator iter, Node* node)
{
...
void ConeDoorZombies::SetShield1SecondaryInjure(map<int, Global::_Zombies>::iterator iter, Node* node)
{
...
void ConeDoorZombies::SetShield1ThirdInjure(map<int, Global::_Zombies>::iterator iter, Node* node)
{
...
void ConeDoorZombies::ZombiesKilledByCar(map<int, Global::_Zombies>::iterator iter, Node* node)
{
